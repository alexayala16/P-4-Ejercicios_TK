...
logo = PhotoImage(file="Guia-1/img/btn-suma.png")
...
bt_sum = PhotoImage(file="Guia-1/img/boton_sumar.png")
...
bt_bor = PhotoImage(file="Guia-1/img/boton_borrar.png")
...
bt_sal = PhotoImage(file="Guia-1/img/boton_salir.png")
